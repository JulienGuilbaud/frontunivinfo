...
export function ContactUpdate() {
    ...
    const doSearch = async () => {
        try {
            setContactData({});
            const adresse = "https://guilbaud.alwaysdata.net/api/contact/details/" + params.contactId;
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch (`https://guilbaud.alwaysdata.net/api/contact/update/`+ params.contactId, {
                method: 'PATCH',
                headers: {
